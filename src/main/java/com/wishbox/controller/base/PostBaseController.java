...
//CRUD METHODS
	...
	public Post insert(@RequestBody Post obj) {
		...
		if (tags != null) {
			PostService.Post_tagsService.updateRelation(result.get_id(), tags);
		}
    ...
    //CRUD - FIND BY Tags
    @Secured({ "ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/post/findBytags/{key}", method = RequestMethod.GET, headers = "Accept=application/json")
	public List<Post> findBytags(@PathVariable("key") Long idtags) {
		List<Post> list = postService.findBytags(idtags);
		return list;
	}
	...
	public Post get(@PathVariable Long id) {
		...
		//external relation tags
		ArrayList<Long> tags = PostService.Post_tagsService.findBy_Post(id);
		obj.setTags(tags);
	...
	public Post update(@RequestBody Post obj, @PathVariable("id") Long id) {
		...
		ArrayList<Long> tags = obj.getTags();
		if (tags != null) {
			PostService.Post_tagsService.updateRelation(id, tags);
		}
