...
//CRUD METHODS
    ...
    @Secured({ "ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/category/findBycreateBy/{key}", method = RequestMethod.GET, headers = "Accept=application/json")
	public List<Category> findBycreateBy(@PathVariable("key") Long idcreateBy) {
		List<Category> list = categoryService.findBycreateBy(idcreateBy);
		return list;
	}
