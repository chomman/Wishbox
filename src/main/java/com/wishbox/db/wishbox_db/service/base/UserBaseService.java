...
import com.wishbox.db.wishbox_db.service.RolesService;
...
public class UserBaseService {
	...
	public User insert(User obj) {
		...
		String sql = "INSERT INTO `user` (`_id`, `username`, `password`, `email`,`name`,`phone`, )	VALUES (:id, :username , :password, :email,:name,:phone, )";
	...
	public void delete(Long id) {
		...
		String sql_user = "DELETE FROM `relation_user` WHERE `id_User`= :id";
	...
	public User update(User obj, Long id) {
		...
		String sql = "UPDATE `User` SET `email`,`name`,`phone`, WHERE `_id`=:id";
		SqlParameterSource parameters = new MapSqlParameterSource()
		    .addValue("id", obj.get_id())
			.addValue("email", obj.getEmail())
			.addValue("name", obj.getName())
