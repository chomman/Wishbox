    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Wishbox</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/categorys">
            <ListItem button key="Category">
              ...
              <ListItemText className="menu-text" primary="Category" />
            </ListItem>
          </Link>{" "}            
           <Link to="/items">
           ...
           <Link to="/posts">
            <ListItem button key="Post">
              ...
              <ListItemText className="menu-text" primary="Post" />
            </ListItem>
          </Link>{" "}            
           <Link to="/relations">
            <ListItem button key="Relation">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Relation" />
            </ListItem>
          </Link>{" "}            
           <Link to="/tags">
            <ListItem button key="Tag">
              ...
              <ListItemText className="menu-text" primary="Tag" />
            </ListItem>
          </Link>{" "}            
           <Link to="/users">
