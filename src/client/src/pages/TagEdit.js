...
class TagEdit extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id !== "new") {
      ...
      this.props.actionsPost.findBytags(this.props.match.params.id);
    ...
    return (
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          {/* External relation with Post */}
          
          <h3>Post</h3>
          {(!this.props.listPost || this.props.listPost.length === 0) && 
            <div>No Post associated</div>
          }
          {this.props.listPost &&
            this.props.listPost.map((item, i) => {
              return (
...
function mapStateToProps(state, ownProps) {
  return {
    ...
    listPost: state.TagEditReducer.listPost,
