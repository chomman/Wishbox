...
import RelationEdit from "./pages/RelationEdit";
import RelationList from "./pages/RelationList";
import TagEdit from "./pages/TagEdit";
import TagList from "./pages/TagList";
import Terms of Use from "./pages/Terms of Use";
        ...
        <Fragment>
          <Paper>
            <div className="main-cointainer">
              ...
              <PrivateRoute exact path="/posts/:id" component={ PostEdit } roles={[ 'ADMIN', ]}  />
              <PrivateRoute exact path="/posts" component={ PostList }  />
              <Route exact path="/terms/privacy" component={ Privacy }  />
              <PrivateRoute exact path="/relations/:id" component={ RelationEdit }  />
              <PrivateRoute exact path="/relations" component={ RelationList }  />
              <PrivateRoute exact path="/tags/:id" component={ TagEdit }  />
              <PrivateRoute exact path="/tags" component={ TagList }  />
              <Route exact path="/terms/use" component={ Terms of Use }  />
